...
disp("-------------");
GoF_train = 100*(1 - (norm(y(1:T_4_days)- y_cap_train(1:T_4_days)'))/(norm(y(1:T_4_days) - y_m_train')));
GoF_test = 100*(1 - (norm(y(T_4_days:time)- y_cap_test'))/(norm(y(T_4_days:time) - y_m_test')));
